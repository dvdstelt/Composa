...
public static class ProjectFile
{
    ...
    public static Document Read(Stream stream)
    {
        ...
        var entry = zip.GetEntry("manifest.json") ?? throw new InvalidDataException("This is not a Compositor project: it has no manifest.");
        ...
        if (manifest.Format != Format) throw new InvalidDataException("This is not a Compositor project.");
